namespace ImmutableObjectGraph.Tests {
    ...
    public class RequiresAndHierarchyTests {
        ...
        public void RequiredFieldNotDeclaredFirst() {
            ReqAndHierL1 value = ReqAndHierL1.Create("value2", Optional<String>.Missing);
        ...
        public void RequiredFieldsAppearInMultipleRelatedTypes() {
            ReqAndHierL2 value = ReqAndHierL2.Create("l1f2Value", "l2f2Value", Optional<System.String>.Missing, Optional<System.String>.Missing);
